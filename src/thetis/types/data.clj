(ns thetis.types.data
  "Platform-specific type data: base type registries for CLJ and CLJS,
   group definitions (:coll, :word, :indexed, :hashed, :builtin),
   and symbolic predicate mappings.")
